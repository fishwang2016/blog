...
#        link = Link(*link_tuple)# pass all the parameters in this link_tuple to Link
#        print link.votes
#    
...
link_table = build_link_index()

link_table.get(44) # Using .get instead of link_table[44] to avoid throwing error
